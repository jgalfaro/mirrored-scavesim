...
public class GUI{
	...
	public static void create(final int nStations, final int nAgents, final int xNet, final int yNet, final String output, 
			final float nodeSize, final float agentSize, final int numbLandmarkToCross, final String shortest_path) throws IOException{
		...
		lSim =  new Simulator(new Record(records, stepByStep), nStations, nAgents, xNet, yNet,0, f, m, output, nodeSize, agentSize, numbLandmarkToCross, shortest_path);
...
//
		...
		panel1.add(new JLabel("Welcome to MAVSIM", JLabel.LEFT));
//		panel1.add(algBox);
