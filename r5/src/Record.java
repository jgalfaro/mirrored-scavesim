...
public class Record{
    ...
    public String initialNodeName1=null;
    public String initialNodeName2=null;
    public String initialNodeName3=null;
    ...
    public String getInitialNode1Name(){
        return this.initialNodeName1;
    }

    public void setInitialNode1Name(String pName){
        this.initialNodeName1=pName;
    }

    public String getInitialNode2Name(){
        return this.initialNodeName2;
    }

    public void setInitialNode2Name(String pName){
        this.initialNodeName2=pName;
    }

    public String getInitialNode3Name(){
        return this.initialNodeName3;
    }

    public void setInitialNode3Name(String pName){
        this.initialNodeName3=pName;
    }
    ...
    public void step(){
        ...
        Enumeration<Node> NodeList = Simulator.nodeList.elements();
        ...
        while (NodeList.hasMoreElements()){
            ...
            i = localNode.howManyKnowMe(Simulator.agentList);
