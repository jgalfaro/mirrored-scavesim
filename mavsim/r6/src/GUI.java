...
public class GUI{
	...
	public static void create(final int nStations, final int nAgents, final int xNet,
		...
		/*lSim =  new Simulator(new Record(records,nBH), nStations, nAgents, xNet, yNet,0,
				MobAgent.class, f, m, nTokens, nBH, showLabels, testA2);
*/
		lSim = Simulator.get();
		...
		// Create spinners
//		int stepNodes=10;
//		int maxNodes=stepNodes*100;
//		int minNodes=stepNodes*3;
//		SpinnerModel spinnerN = new SpinnerNumberModel(nStations, minNodes, maxNodes, stepNodes);
//		final JSpinner numNodesSpinner = new JSpinner(spinnerN);
		...
		//panel2.add(new JLabel("N. Nodes:"), "cell 0 1");
		//panel2.add(numNodesSpinner, "cell 1 1");
...
// 			public void actionPerformed(ActionEvent e) {
// 				Simulator.get().recalc(/*((Integer)numNodesSpinner.getValue())*/nStations,((Integer)numAgentsSpinner.getValue()),((Integer)numBHSpinner.getValue()));
